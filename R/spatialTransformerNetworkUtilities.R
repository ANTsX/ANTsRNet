...
SpatialTransformerLayer2D <- R6::R6Class( "SpatialTransformerLayer2D",
                                          ...
                                          public = list(
                                            ...
                                            makeRegularGrids = function( batchSize, resampledSize )
                                            {
                                              ...
                                              regularGrids <- K$tile( regularGrid, K$shape( K$placeholder( shape = ( batchSize ) ) ) )
...
layer_spatial_transformer_2d <- function(
  ...
  create_layer( SpatialTransformerLayer2D, object,
...
layer_spatial_transformer_3d <- function(
  ...
  resampledSize, transformType = 'affine',
  interpolatorType = 'linear', name = NULL ) {
  create_layer( SpatialTransformerLayer3D, object,
                list( resampledSize = resampledSize, transformType = transformType,
                      interpolatorType = interpolatorType, name = name )
  )
}
